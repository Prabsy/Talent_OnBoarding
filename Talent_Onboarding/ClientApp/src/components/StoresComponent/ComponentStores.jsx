...
import ConfirmDeleteStore from './ConfirmDeleteStore'
import CreateStore from './CreateStore'
import UpdateStore from './UpdateStore'
import ActionsStore from './ActionsStore'


class ComponentStores extends Component {
    static displayName = ComponentStores.name;
    constructor(props) {
        super(props);
        this.state = {
            stores: [],
    ...
    render() {
        ...
        const { stores, toggleCreateModal, toggleDeleteModal, toggleUpdateModal, postsPerPage } = this.state;
        ...
        return (
            <div>
                ...
                <CreateStore open={toggleCreateModal} toggleModal={this.togglePostModal} getStores={this.getStores} />
                <Button primary onClick={() => this.togglePostModal()}><Icon name="add" />Create Store</Button>
                <Table celled>
                    <Table.Header>
                        <Table.Row>
                    ...
                    <ActionsStore stor={currentPosts} toggledelModal={this.toggledelModal} togglePutModal={this.togglePutModal} />
...
export default ComponentStores;
